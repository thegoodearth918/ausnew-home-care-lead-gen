...
def create_assistant(client):
  ...
  if os.path.exists(assistant_file_path):
    ...
    files.append(client.files.create(file=open("60-Seconds Free Evaluation.docx", "rb"), purpose='assistants'))
    ...
    assistant = client.beta.assistants.create(
        ...
        tools=[
            ...
            },
            {
                "type": "function",  
                "function": {
                    "name": "capture_lead_60s_free_evaluation",
                    "description": "Capture the lead details during 60 Seconds free evaluation",
                    "parameters": {
                        "type": "object",
                        "properties": {
            ...
            },
            {
                "type": "function",  
                "function": {
                    "name": "capture_lead_no-cost_evaluation_for_accommodation",
                    "description": "Capture the lead details during no-cost evaluation for accommodation",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "in_what_way": {
